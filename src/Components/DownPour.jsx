    ...
    return (
        <div className="container">
            ...
            <div className="dpBackground">
                <img src="../src/assets/DownPourBanner.png" alt="" /> 
            </div>
                ...
                <div className="dpBiography">
                    ...
                    <ul className='newSlugcats'>
                        <li className='slugcat'>
                            <img src="../src/assets/artificier.png" alt="" />
                        ...
                        <li className='slugcat'>
                            <img src="../src/assets/gourmand.png" alt="" />
                            <div className="aboutSC">
                                <h1>The Gourmand</h1>
                        ...
                        <li  className='slugcat'>
                            <img src="../src/assets/rivulet.png" alt="" />
                            <div className="aboutSC">
                                <h1>The Rivulet</h1>
                        ...
                        <li className='slugcat'>
                            <img src="../src/assets/saint.png" alt="" />
                            <div className="aboutSC">
                                <h1>The Saint</h1>
                        ...
                        <li className='slugcat'>
                            <img src="../src/assets/spearmaster.png" alt="" />
                            <div className="aboutSC">
